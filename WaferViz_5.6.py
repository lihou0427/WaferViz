...
# cross_section
        ...
        if (degree_theta == 0):
            ...
            Z_theta_90 = griddata((x_theta_90, y_theta_90), z, (X_theta, Y_theta),
                                  method="cubic")
            ax4.plot(X_theta, Z_theta, 'o', color='green', markersize=1, alpha=0.01)
            ax4.plot(X_theta, Z_theta_90, 'o', color='orange', markersize=1, alpha=0.01)
            ...
            plot_id3_resized = img3.resize((365, 260))
            plot_id3_resized.save("cross_resized.png")     
            img33 = ImageTk.PhotoImage(Image.open("cross_resized.png"))
            self.canvas_graph.create_image(25, 435, anchor="nw", image=img33)
            ...
            Z_oth_r = griddata((x_oth_r, y_oth_r), z, (X_theta_r, Y_theta_r),
                                method="cubic")
            ax4r.plot(X_theta_r, Z_theta_r, 'o', color='Green', markersize=1, alpha=0.01)
            ax4r.plot(X_theta_r, Z_oth_r, 'o', color='Orange', markersize=1, alpha=0.01)
            ...
            plot_id3r_resized = img3r.resize((365, 260))
            plot_id3r_resized.save("cross_resized2.png")     
            img33r = ImageTk.PhotoImage(Image.open("cross_resized2.png"))
            self.canvas_graph.create_image(25, 435, anchor="nw", image=img33r)
...
# 3d_contour
        if (value_rotation == 0):
            ...
            plot_id3d_resized = img3d.resize((375, 375))
            plot_id3d_resized.save("3d_resized.png")     
            img33d = ImageTk.PhotoImage(Image.open("3d_resized.png"))
            self.canvas_graph.create_image(460, 0, anchor="nw", image=img33d)
            ...
            plot_id3dr_resized = img3dr.resize((375, 375))
            plot_id3dr_resized.save("3dr_resized.png")     
            img33dr = ImageTk.PhotoImage(Image.open("3dr_resized.png"))
            self.canvas_graph.create_image(460, 0, anchor="nw", image=img33dr)
...
# scatter1
        ...
        self.canvas_graph.create_image(25, 685, anchor="nw", image=img5)
...
# scatter2
        ...
        self.canvas_graph.create_image(415, 685, anchor="nw", image=img6)
...
# cumulative distribution
        ...
        ax_cdf.set_xlabel('Thickness (Å)', fontsize=6)
...
# contour
        ...
        if (value_rotation == 0):
            ...
            img11 = ImageTk.PhotoImage(Image.open("contour_resized.png"))
            self.canvas_graph.create_image(65, 35, anchor="nw", image=img11)
            worksheet.insert_image('D2', 'contour.png', {'x_scale': 1.46, 'y_scale': 1.52})
            os.remove("contour_resized.png")
            plt.clf()
            plt.close(fig1)
...
# cross_section
        ...
        if (degree_theta == 0):
            ...
            img33 = ImageTk.PhotoImage(Image.open("cross_resized.png"))
            self.canvas_graph.create_image(25, 435, anchor="nw", image=img33)
            worksheet.insert_image('D22', 'cross_section.png', {'x_scale': 1.6, 'y_scale': 1.6})
            os.remove("cross_resized.png")
            plt.clf()
            plt.close(fig3)
...
# 3d_contour
        if (value_rotation == 0):
            ...
            plot_id3d_resized.save("3d_resized.png")     
            img33d = ImageTk.PhotoImage(Image.open("3d_resized.png"))
            worksheet.insert_image('J1', '3d.png', {'x_scale': 1.4, 'y_scale': 1.55})
            self.canvas_graph.create_image(460, 0, anchor="nw", image=img33d)
            os.remove("3d_resized.png")
            plt.clf()
            plt.close(fig3d)
...
# scatter1
        ...
        img5 = ImageTk.PhotoImage(Image.open("scatter1_resized.png")) 
        self.canvas_graph.create_image(25, 685, anchor="nw", image=img5)
        worksheet.insert_image('D36', 'scatter1.png', {'x_scale': 1.7, 'y_scale': 1.7})
        os.remove("scatter1_resized.png")
        plt.clf()
        plt.close(fig5)
...
# scatter2
        ...
        img6 = ImageTk.PhotoImage(Image.open("scatter2_resized.png")) 
        self.canvas_graph.create_image(415, 685, anchor="nw", image=img6)
        worksheet.insert_image('J36', 'scatter2.png', {'x_scale': 1.7, 'y_scale': 1.7})
        os.remove("scatter2_resized.png")
        plt.clf()
        plt.close(fig6)
...
# histogram
        ...
        img10 = ImageTk.PhotoImage(Image.open("hist_resized.png")) 
        self.canvas_graph.create_image(50, 945, anchor="nw", image=img10)
        worksheet.insert_image('D50', 'hist.png', {'x_scale': 1.5, 'y_scale': 1.5})
        os.remove("hist_resized.png")
        plt.clf()
        plt.close(fig10)
...
# cumulative distribution
        ...
        img_cdf = ImageTk.PhotoImage(Image.open("cdf_resized.png")) 
        self.canvas_graph.create_image(440, 945, anchor="nw", image=img_cdf)
        worksheet.insert_image('J50', 'cdf.png', {'x_scale': 1.5, 'y_scale': 1.5})
        os.remove("cdf_resized.png")
        plt.clf()
        plt.close(fig_cdf)
